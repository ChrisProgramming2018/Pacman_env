...
class PacmanEnv(gym.Env):
    ...
    def reset(self, layout=None):
        ...
        self.chooseLayout(randomLayout=False, chosenLayout=layout, no_ghosts=False)
        ...
        print(MAX_GHOSTS)
        #sys.exit()
        self.ghosts = [DirectionalGhost( i+1, prob_attack=1, prob_scaredFlee=0.2) for i in range(MAX_GHOSTS)]
